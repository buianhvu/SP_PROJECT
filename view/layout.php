    ...
    <body>
        <header>
            ...
            if (isset($_SESSION['username'])) {
                ...
                echo "<a href='index.php?controller=profile&action=display' align='right'> Profile </a>";
                echo "<a href='index.php?controller=logout&action=logout' style='margin-right: 10px'> Logout</a>";
            }
